  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      <h1 className="text-3xl font-bold text-purple-500 mb-4">
        Optimal Page Replacement Result
      </h1>

      {/* Definition Section */}
      <div className="bg-white shadow-md rounded-lg p-4 w-full max-w-3xl mt-4">
        <h2 className="text-xl font-semibold text-gray-700">
          Definition of Optimal Page Replacement:
        </h2>
        <p className="text-gray-600">
          The Optimal Page Replacement algorithm replaces the page that will not
          be used for the longest period of time in the future. It ensures the
          least number of page faults, but it requires future knowledge of page
          requests, making it impractical for real-time use.
        </p>
      </div>
      {/* Working Principle */}
      <div className="bg-white shadow-md rounded-lg p-4 w-full max-w-3xl mt-4">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600 pl-6">
            ...
            <br />- Keep track of future page requests to determine which page
            should be replaced.
          </p>
          ...
          <p className="text-gray-600 pl-6">
            ...
            - If memory is full, predict which page will not be used for the
            longest duration and replace it. <br />- This ensures minimal page
            faults but requires future knowledge.
          </p>
        </div>
      </div>
